...
export default function Dashboard() {
  ...
  const deleteRoom = async (roomId: string) => {
    if (!confirm(t('dashboard.confirmDelete') || 'Are you sure you want to delete this room?')) {
      return;
    }

    try {
      const response = await fetch(`${BACKEND_URL}/api/v1/dashboard/rooms/${roomId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${accessToken}`,
        },
  ...
  const deleteTranscript = async (transcriptId: string) => {
    ...
    try {
      ...
      if (response.ok) {
        setSavedTranscripts(savedTranscripts.filter(t => t.id !== transcriptId));
      }
    } catch (error) {
      ...
      <main className={styles.main}>
        <div className={styles.container}>
            ...
            <div className={styles.statsGrid}>
              <div className={styles.statCard}>
                ...
                <div className={styles.statContent}>
                  ...
                  <div className={styles.statLabel}>{t('dashboard.totalRooms')}</div>
                </div>
              </div>
              ...
              <div className={styles.statCard}>
                ...
                <div className={styles.statContent}>
                  ...
                  <div className={styles.statLabel}>{t('dashboard.activeRooms')}</div>
                </div>
              </div>
              ...
              <div className={styles.statCard}>
                ...
                <div className={styles.statContent}>
                  ...
                  <div className={styles.statLabel}>{t('dashboard.totalListeners')}</div>
                </div>
              </div>
              ...
              <div className={styles.statCard}>
                ...
                <div className={styles.statContent}>
                  <div className={styles.statValue}>{stats.totalTranscripts}</div>
                  <div className={styles.statLabel}>{t('dashboard.totalTranscripts')}</div>
                </div>
              </div>
            </div>
          )}
          ...
          <div className={styles.tabs}>
            ...
            <button
              className={activeTab === 'transcripts' ? styles.tabActive : styles.tab}
                      ...
                      {rooms.map((room) => (
                        <div key={room.id} className={styles.roomCard}>
                          <div className={styles.roomHeader}>
                            ...
                            <div className={`${styles.status} ${getStatusColor(room.status)}`}>
                          ...
                          <div className={styles.roomBody}>
                            <h3 className={styles.roomTitle}>{room.speakerName}</h3>
                  ...
                  {savedTranscripts.length === 0 ? (
                    ...
                    <div className={styles.transcriptsList}>
                      {savedTranscripts.map((transcript) => (
                        <div key={transcript.id} className={styles.transcriptCard}>
                          ...
                          <div className={styles.transcriptContent}>
                            <h3 className={styles.transcriptTitle}>
                              {transcript.roomName || `Room ${transcript.roomCode}`}
                            </h3>
