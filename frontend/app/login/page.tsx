        ...
        <div className={styles.brand}>
          <div className={styles.logoIcon}>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="url(#logoGradient)" opacity="0.15"/>
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" stroke="url(#logoGradient)" strokeWidth="1.5"/>
              <path d="M8 12l2 2 4-4" stroke="url(#logoGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <defs>
          ...
          {step === 'email' && (
            <form onSubmit={handleEmailSubmit} className={styles.form}>
              ...
              <div className={styles.socialButtons}>
                ...
                <button type="button" disabled className={styles.socialButton}>
                  <svg className={styles.socialIcon} viewBox="0 0 24 24">
                    <circle fill="#FEE500" cx="12" cy="12" r="10"/>
                    <path fill="#3C1E1E" d="M12 6c-3.314 0-6 2.239-6 5 0 1.764 1.143 3.307 2.857 4.222l-.514 1.872c-.07.257.22.472.458.338l2.153-1.184c.344.05.697.076 1.046.076 3.314 0 6-2.239 6-5s-2.686-5-6-5z"/>
                  </svg>
                  Kakao
                </button>
              </div>
